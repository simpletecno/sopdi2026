 ...
 * @author JAguirre
 */
public class EmpleadoAsistenciaIdexPDF extends Window {
    ...
    public EmpleadoAsistenciaIdexPDF(
            String fechaPlan,
...
//            buttonLayout.setWidth("100%");
            ...
            fileName = "GrupoTrabajAsistenciaIdex_" + new Utileria().getFechaHoraSinFormato() + ".pdf";
            ...
            Notification.show("Error al generar el reporte de asistencia diaria + idex.", Notification.Type.ERROR_MESSAGE);
...
//                PdfWriter.getInstance(document2, os);
                ...
                event.setFirstLineReportTitle(" ASISTENCIA DIARIA DE EMPLEADOS + IDEX");
...
//                addTitlePage(document2);
        ...
        private void addMetaData(Document document) {
            document.addTitle("ASISTENCIA DIARIA + IDEX AL : " + Utileria.getFechaDDMMYYYY(new java.util.Date()));
        ...
        private void addTitlePage(Document document) {
            ...
            try {
                ...
                float[] columnWidths = {2.0f, 3.0f, 2.5f, 3.0f};
        ...
        private void addEmployeeTable(Document document) {
            ...
            try {
                ...
                float[] columnWidth = {1.0f, 3.5f, 1.0f, 4.0f};
...
//                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(EmpleadoAsistenciaView.GRUPONOMBRE_PROPERTY).getValue()), small8));
                    ...
                    c2 = new PdfPCell(new Paragraph(asistenciaContainer.getItem(itemId).getItemProperty(EmpleadoAsistenciaView.IDEMPLEADO_PROPERTY).getValue() + " " + asistenciaContainer.getItem(itemId).getItemProperty(EmpleadoAsistenciaView.EMPLEADO_PROPERTY).getValue(), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);
                    ...
                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(EmpleadoAsistenciaView.IDEX_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);
                }
