 ...
 * @author JAguirre
 */
public class GrupoTrabajoRepPlanillaPDF extends Window {
    ...
    public GrupoTrabajoRepPlanillaPDF(
            String fechaPlan,
...
//            buttonLayout.setWidth("100%");
            ...
            fileName = "GrupoTrabajoRepPlanilla_" + fechaPlan + "_" + new Utileria().getFechaHoraSinFormato() + ".pdf";
...
//                }
            ...
            Notification.show("Error al generar el reporte para planilla.", Notification.Type.ERROR_MESSAGE);
...
//                PdfWriter.getInstance(document2, os);
                ...
                event.setFirstLineReportTitle(" REPORTE PARA PLANILLA ");
                event.setCompanyName(((SopdiUI) UI.getCurrent()).sessionInformation.getStrAccountingCompanyId() + " " + ((SopdiUI) UI.getCurrent()).sessionInformation.getStrAccountingCompanyName());
                ...
                event.setSecondLineReportTitle( ((SopdiUI) UI.getCurrent()).sessionInformation.getStrProjectName() + " MES : " + fechaPlan);
...
//                addTitlePage(document2);
        ...
        private void addMetaData(Document document) {
            document.addTitle("REPORTE PARA PLANILLA : " + fechaPlan + "_"  + Utileria.getFechaDDMMYYYY(new java.util.Date()));
        ...
        private void addEmployeeTable(Document document) {
            ...
            try {
                ...
                float[] columnWidth = {1.0f, 3.5f, 2.0f, 1.5f, 1.5f, 1.0f};

                table.setWidths(columnWidth);

                PdfPCell
                c2 = new PdfPCell(new Paragraph("ID", smallBold10));
                ...
                c2 = new PdfPCell(new Paragraph("DIAS", smallBold10));
                c2.setHorizontalAlignment(Element.ALIGN_CENTER);
                c2.setVerticalAlignment(Element.ALIGN_CENTER);
                c2.setBorderWidth(2);
                table.addCell(c2);
                ...
                for(Object itemId : asistenciaContainer.getItemIds()) {
                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.IDEMPLEADO_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);

                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.EMPLEADO_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);

                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.CARGO_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);

                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.GRUPONOMBRE_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c2.setBorderWidth(0);
                    table.addCell(c2);

                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.IDEX_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c2.setBorderWidth(0);
                    table.addCell(c2);

                    c2 = new PdfPCell(new Paragraph(String.valueOf(asistenciaContainer.getItem(itemId).getItemProperty(GrupoTrabajoRepPlanillaView.DIAS_PROPERTY).getValue()), small8));
                    c2.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c2.setBorderWidth(0);
                    table.addCell(c2);
                }
