...
public class ChequeTesoreriaForm extends Window {
    ...
    public ChequeTesoreriaForm() {
        ...
        titleLbl = new Label(empresaId
                 + " " + empresaNombre + " CHEQUES TESORERIA");
...
//        queryString += " WHERE N0 in (4, 6, 7, 9)";
    ...
    public HorizontalLayout crearComponentes() {
        ...
        tipoIngresoCbx.addItem("CHEQUE TESORERIA");
        ...
        proveedorCbx.addValueChangeListener((event) -> {
            if (tipoIngresoCbx.getValue().equals("CHEQUE TESORERIA")) {
                llenarTablaChquesNoConciliados();
            }
        });
        ...
        medioCbx.select("NOTA DE CREDITO");
                ...
                if (facturasGrid.getSelectedRows() != null) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (!moneda.equals(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem).getItemProperty(MONEDA_DOCUMENTO_PROPERTY).getValue()))) {
                            Notification.show("SOLO SE PUEDEN INGRESAR VARIOS CHEQUES DEL MISMO PROVEEDOR Y DE LA MISMA MONEDA, REVISE!", Notification.Type.WARNING_MESSAGE);
                    ...
                    while (iter2.hasNext()) {
                        ...
                        if (cuentaContable2Cbx.getValue() == null) {
                            ...
                            cuentaContable2Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
                            if(montoDisponible <= Double.valueOf(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""))) {
                                ...
                                facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_PAGADO_PROPERTY).setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
                            }
                            ...
                            cuentaContable3Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
                            if(montoDisponible <= Double.valueOf(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""))) {
                            ...
                            cuentaContable4Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
                            if(montoDisponible <= Double.valueOf(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""))) {
                            ...
                            cuentaContable5Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
                            if(montoDisponible <= Double.valueOf(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""))) {
                                haber4Txt.setValue(montoDisponible);
                                facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_PAGADO_PROPERTY).setValue(String.valueOf(montoDisponible));
                            }
                            ...
                            cuentaContable6Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
//                            haber6Txt.setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
                            ...
                            cuentaContable7Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
//                            haber7Txt.setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
                            ...
                            cuentaContable8Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
//                            haber8Txt.setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
                            ...
                            cuentaContable9Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
//                            haber9Txt.setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
                            ...
                            cuentaContable10Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getChequesTesoreria());
//                            haber10Txt.setValue(String.valueOf(facturasGrid.getContainerDataSource().getItem(gridItem2).getItemProperty(MONTO_DOCUMENTO_PROPERTY).getValue()).replaceAll(",", ""));
        ...
        guardarBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                if (!validarCamposParaIngresarChequesNoConciliados()) {
    ...
    public void llenarTablaChquesNoConciliados() {


        GregorianCalendar fecha_date = new GregorianCalendar();
        fecha_date.setTime(Utileria.getTomorrow());
        String fechaInicial = Utileria.getFechaYYYYMMDD_1(Date.from(fecha_date.getTime().toInstant().minus(30 * 6 + 6, ChronoUnit.DAYS)));


        facturasContainer.removeAllItems();

        queryString = " SELECT * FROM contabilidad_partida ";
        queryString += " WHERE TipoDocumento IN ('CHEQUE')";
        queryString += " AND IdProveedor = " + proveedorCbx.getValue();
        queryString += " AND IdEmpresa = " + empresaId;
        queryString += " AND IdConciliacion = 0";
        queryString += " AND Estatus <> 'ANULADO'";
        queryString += " AND IdNomenclatura in (" + ((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getBancosMonedaLocal() + ", " + ((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getBancosMonedaExtranjera() + ")";
        queryString += " AND Fecha < '" + fechaInicial + "'";

        Logger.getLogger(this.getClass().getName()).log(Level.INFO,"QUERY BUSCAR CHEQUES NO CONSILIADOS DE UN PROVEEDOR (CIENTE) : " + queryString);
        ...
        try {
            ...
            if (rsRecords.next()) {
                do {
                    ...
                    queryString += " WHERE CodigoPartida = '" + rsRecords.getString("CodigoPartida") + "'";
...
// no es necesario                   queryString += " Order by contabilidad_partida.NombreProveedor";
            ...
            System.out.println("Error al listar tabla de Cheques : " + ex);
            Notification.show("ERROR AL LEER CHEQUE : " + ex.getMessage(), Notification.Type.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }

    public boolean validarCamposParaIngresarChequesNoConciliados() {
    ...
    public void actualizarSaldosFacturas() {
        ...
        ingresarChequeTesoreria();
    }

    public void ingresarChequeTesoreria() {
        ...
        Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Ingreso de Cheque Tesoreria = " + queryString);
        ...
        try {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,"Error al insertar Cheque Tesoreria: " + ex1.getMessage());
            ex1.printStackTrace();
            ...
            try {
                ...
                Logger.getLogger(ChequeTesoreriaForm.class.getName()).log(Level.SEVERE, null, ex);
            }
