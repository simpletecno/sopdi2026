...
public class PagarView extends VerticalLayout implements View {
    ...
    public PagarView() {
        ...
        titleLayout.addComponents(fechaDt, refreshBtn);
        titleLayout.setComponentAlignment(fechaDt, Alignment.TOP_CENTER);
        titleLayout.setComponentAlignment(refreshBtn, Alignment.TOP_CENTER);
...
//System.out.println("Query llenarAutorizacion" + queryString);
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        ((SopdiUI) UI.getCurrent()).lblEmpresaYFormulario.setValue(empresaId + " " + empresaNombre + " PAGAR");
