 ...
 * @author user
 */
public class IngresoEnganchesForm extends Window {
    ...
    public IngresoEnganchesForm(String codigoPartida) {
        ...
        titleLbl = new Label(empresaId + " " + empresaNombre + " INGRESO A BANCOS ENGANCHES CLIENTE");
...
//        horizontalLayout.setExpandRatio(rightVerticalLayout, 3);
        ...
        fechaDt.addValueChangeListener(e -> {
            if (fechaDt.getValue() != null) {
                tipoCambioTxt.setValue(((SopdiUI)mainUI).getTasaCambioDelDia(Utileria.getFechaYYYYMMDD_1(fechaDt.getValue())));
                actualizarDebeHaber();
            }
        });
        ...
        tipoCambioTxt.addValueChangeListener(new Property.ValueChangeListener() {
            public void valueChange(Property.ValueChangeEvent event) {
                actualizarDebeHaber();
            }
        });
...
//            System.out.println("Seleccionar este");
    ...
    public void generarPartidaEnganches() {
        ...
        cuentaContable2Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getEnganches());
...
//          debe1Txt.setValue(Utileria.numberFormatEntero.format(montoTxt.getDoubleValueDoNotThrow() * tipoCambioTxt.getDoubleValueDoNotThrow()));
            ...
            debe3Txt.setValue(0.00); //dif cambiario
            haber3Txt.setValue(Utileria.numberFormatEntero.format(montoTxt.getDoubleValueDoNotThrow() - (montoTxt.getDoubleValueDoNotThrow() / tipoCambioTxt.getDoubleValueDoNotThrow())));  //diferencial cambiario
    ...
    public void ingresarEnganches() {
        ...
        queryString += " SerieDocumento, NumeroDocumento, MontoDocumento, IdNomenclatura, MonedaDocumento, Debe, Haber,";
        ...
        queryString += "," + debe1Txt.getDoubleValueDoNotThrow();
        queryString += "," + haber1Txt.getDoubleValueDoNotThrow();
        queryString += "," + debe1QTxt.getDoubleValueDoNotThrow();
        queryString += "," + haber1QTxt.getDoubleValueDoNotThrow();
        queryString += "," + tipoCambioTxt.getDoubleValueDoNotThrow();
        queryString += "," + montoTxt.getDoubleValueDoNotThrow();
        queryString += ",'Ingreso por ENGANCHE CLIENTE " + tipoEngancheCbx.getValue() + " " + descripcionTxt.getValue() + "'";
...
// segundo  ingreso
        ...
        queryString += ",'" + monedaCbx.getValue() + "'";
        queryString += "," + debe2Txt.getDoubleValueDoNotThrow();
        queryString += "," + haber2Txt.getDoubleValueDoNotThrow();
        queryString += "," + debe2QTxt.getDoubleValueDoNotThrow();
        queryString += "," + haber2QTxt.getDoubleValueDoNotThrow();
        queryString += "," + tipoCambioTxt.getDoubleValueDoNotThrow();
        queryString += "," + montoTxt.getDoubleValueDoNotThrow();
        queryString += ",'Ingreso por ENGANCHE CLIENTE " + proveedorCbx.getItemCaption(proveedorCbx.getValue()) + " " + descripcionTxt.getValue() + "'";
        queryString += "," + ((SopdiUI) mainUI).sessionInformation.getStrUserId();
        queryString += ",current_timestamp";
        queryString += ")";
...
// tercer  ingreso
        ...
        queryString += "," + haber3Txt.getDoubleValueDoNotThrow();
        queryString += "," + debe3QTxt.getDoubleValueDoNotThrow();
        queryString += "," + haber3QTxt.getDoubleValueDoNotThrow();
        queryString += "," + tipoCambioTxt.getDoubleValueDoNotThrow();
        queryString += "," + montoTxt.getDoubleValueDoNotThrow();
        queryString += ",'Ingreso por ENGANCHE CLIENTE " + tipoEngancheCbx.getValue() + " " + descripcionTxt.getValue() + "'";
        queryString += "," + ((SopdiUI) mainUI).sessionInformation.getStrUserId();
