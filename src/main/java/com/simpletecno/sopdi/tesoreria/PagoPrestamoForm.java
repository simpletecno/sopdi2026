 ...
 * @author user
 */
public class PagoPrestamoForm extends Window {

    VerticalLayout mainLayout;

    static final String NO = "No.";
    static final String ID_PROVEEDOR = "Cod. Proveedor";
    ...
    public IndexedContainer prestamosContainer = new IndexedContainer();
    Grid prestamosGrid;

    ComboBox tipoPrestamoCbx;
    ...
    public PagoPrestamoForm(String codigoPartidaSeleccionado, String cuentaLiquidar, Date fechaPago) {      
        ...
        Label titleLbl = new Label("PAGO DE PRESTAMOS");
        ...
        tipoPrestamoCbx = new ComboBox("Tipo");

        tipoPrestamoCbx.addItem("PAGO DE PRESTAMO");
        tipoPrestamoCbx.addItem("PAGO DE INTERESES");
        tipoPrestamoCbx.addItem("PAGO DE COMISIONES");
        tipoPrestamoCbx.select("PAGO DE PRESTAMO");
        tipoPrestamoCbx.addStyleName(ValoTheme.COMBOBOX_LARGE);
        tipoPrestamoCbx.setWidth("20em");
        tipoPrestamoCbx.addValueChangeListener(event -> {
            generarPagoPrestamos();
        });
        ...
        mainLayout.addComponent(tipoPrestamoCbx);
        mainLayout.setComponentAlignment(tipoPrestamoCbx, Alignment.TOP_CENTER);
        ...
        if(prestamosContainer.size()>0){
            prestamosGrid.select(prestamosContainer.firstItemId());
        }
    ...
    public void crearGridPrestamos() {
        ...
        prestamosContainer.addContainerProperty(NO, String.class, null);
        prestamosContainer.addContainerProperty(ID_PROVEEDOR, String.class, null);
        prestamosContainer.addContainerProperty(PROVEEDOR, String.class, null);
        prestamosContainer.addContainerProperty(CREADOFECHA, String.class, null);
        prestamosContainer.addContainerProperty(CREADOPOR, String.class, null);
        prestamosContainer.addContainerProperty(MONEDA, String.class, null);
        prestamosContainer.addContainerProperty(MONTO, String.class, null);

        prestamosGrid = new Grid("Prestamos autorizados", prestamosContainer);

        prestamosGrid.setImmediate(true);
        prestamosGrid.setSelectionMode(Grid.SelectionMode.SINGLE);
        prestamosGrid.setDescription("Seleccione un registro.");
        prestamosGrid.setHeightMode(HeightMode.ROW);
        prestamosGrid.setHeightByRows(4);
        prestamosGrid.setWidth("100%");
        prestamosGrid.setResponsive(true);
        prestamosGrid.setEditorBuffered(false);

        prestamosGrid.addSelectionListener(new SelectionListener() {
            @Override
            public void select(SelectionEvent event) {

                if (prestamosGrid.getSelectedRow() != null) {

                    monedaCbx.setReadOnly(false);
                    String mondeda = String.valueOf(prestamosContainer.getContainerProperty(prestamosGrid.getSelectedRow(), MONEDA).getValue());
                    validadMoneda(mondeda);
                    monedaCbx.setReadOnly(true);

                    montoTxt.setReadOnly(false);
                    String monto = String.valueOf(prestamosContainer.getContainerProperty(prestamosGrid.getSelectedRow(), MONTO).getValue()).replaceAll(",", "");
                    ...
                    debe1Txt.setReadOnly(true);
                    haber2Txt.setReadOnly(true);

                    nombreChequeTxt.setReadOnly(false);
                    nombreChequeTxt.setValue(String.valueOf(prestamosContainer.getContainerProperty(prestamosGrid.getSelectedRow(), PROVEEDOR).getValue()));
                    nombreChequeTxt.setReadOnly(false);

                    proveedorCbx.setReadOnly(false);
                    proveedorCbx.select(String.valueOf(prestamosContainer.getContainerProperty(prestamosGrid.getSelectedRow(), ID_PROVEEDOR).getValue()));
        ...
        prestamosGrid.setCellStyleGenerator((Grid.CellReference cellReference) -> {
        ...
        reportLayout.addComponent(prestamosGrid);
        reportLayout.setComponentAlignment(prestamosGrid, Alignment.MIDDLE_CENTER);
    ...
    public void llenarGridPrestamos() {
        prestamosContainer.removeAllItems();
        ...
        try {
            ...
            if (rsRecords.next()) { //  encontrado
                do {
                    Object itemId = prestamosContainer.addItem();

                    prestamosContainer.getContainerProperty(itemId, NO).setValue(rsRecords.getString("IdAutorizacion"));
                    prestamosContainer.getContainerProperty(itemId, ID_PROVEEDOR).setValue(rsRecords.getString("IdProveedor"));
                    prestamosContainer.getContainerProperty(itemId, PROVEEDOR).setValue(rsRecords.getString("Nombre"));
                    prestamosContainer.getContainerProperty(itemId, CREADOFECHA).setValue(Utileria.getFechaDDMMYYYY(rsRecords.getDate("Fecha")));
                    prestamosContainer.getContainerProperty(itemId, CREADOPOR).setValue(rsRecords.getString("nombre"));
                    prestamosContainer.getContainerProperty(itemId, MONEDA).setValue(rsRecords.getString("Moneda"));
                    prestamosContainer.getContainerProperty(itemId, MONTO).setValue(numberFormat.format((rsRecords.getDouble("Monto"))));
...
//        layoutHorizontal6.setMargin(new MarginInfo(true,false,false,false));
        ...
        cuentaContable1Cbx.addContainerProperty("CODIGOCC", String.class, "");
        ...
        cuentaContable2Cbx.addContainerProperty("CODIGOCC", String.class, "");
        ...
        cuentaContable3Cbx.addContainerProperty("CODIGOCC", String.class, "");
        ...
        cuentaContable4Cbx.addContainerProperty("CODIGOCC", String.class, "");
        ...
        cuentaContable5Cbx.addContainerProperty("CODIGOCC", String.class, "");
        ...
        desAutorizarBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                if (prestamosGrid.getSelectedRows() != null) {
                    desAutorizarFactura();
                }
            }
        });
        ...
        layoutHorizontal6.setComponentAlignment(desAutorizarBtn, Alignment.BOTTOM_RIGHT);
...
//      queryString += " where FiltrarFormularioLiquidacion = ?";
        ...
        try {
            ...
            while (rsRecords.next()) { //  encontrado
                ...
                cuentaContable1Cbx.getContainerProperty(rsRecords.getString("IdNomenclatura"), "CODIGOCC").setValue(empresaCbx.getValue() + rsRecords.getString("CodigoCC"));
                ...
                cuentaContable2Cbx.getContainerProperty(rsRecords.getString("IdNomenclatura"), "CODIGOCC").setValue(empresaCbx.getValue() + rsRecords.getString("CodigoCC"));
                ...
                cuentaContable3Cbx.getContainerProperty(rsRecords.getString("IdNomenclatura"), "CODIGOCC").setValue(empresaCbx.getValue() + rsRecords.getString("CodigoCC"));
                ...
                cuentaContable4Cbx.getContainerProperty(rsRecords.getString("IdNomenclatura"), "CODIGOCC").setValue(empresaCbx.getValue() + rsRecords.getString("CodigoCC"));
                ...
                cuentaContable5Cbx.getContainerProperty(rsRecords.getString("IdNomenclatura"), "CODIGOCC").setValue(empresaCbx.getValue() + rsRecords.getString("CodigoCC"));
            }
    ...
    public void generarPagoPrestamos() {
        ...
        if (String.valueOf(tipoPrestamoCbx.getValue()).equals("PAGO DE PRESTAMO")) {
//            cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getPrestamos());
            cuentaContable1Cbx.select(cuentaLiquidar);
        }
        if (String.valueOf(tipoPrestamoCbx.getValue()).equals("PAGO DE INTERESES")) {
            cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getInteresesPrestamo());
        }

//        cuentaContable1Cbx.setReadOnly(true);
        debe1Txt.setReadOnly(false);
        debe1Txt.setValue(montoTxt.getDoubleValueDoNotThrow());
        debe1Txt.setReadOnly(true);
    ...
    public void insertarPartidaPrestamo() {
...
//        double debe = (debe1Txt.getDoubleValueDoNotThrow() + debe2Txt.getDoubleValueDoNotThrow());
//        double haber = haber3Txt.getDoubleValueDoNotThrow();
...
//        }
//
//        if (debe != montoTxt.getDoubleValueDoNotThrow()) {
//            Notification.show("El monto del debe esta descuadrado por favor revisarlo", Notification.Type.WARNING_MESSAGE);
//            debe1Txt.focus();
//            return;
//        }
        if (debe1Txt.getDoubleValueDoNotThrow() != haber2Txt.getDoubleValueDoNotThrow()) {
            Notification.show("El monto del debe esta descuadrado por favor revisarlo", Notification.Type.WARNING_MESSAGE);
//            montoTxt.focus();
            return;
        }
        ...
        String codigoPartida = empresaCbx.getValue() + año + mes + dia + "3";
        ...
        String descripcion = "PAGO DE " + tipoPrestamoCbx.getValue() + " " + descripcionTxt.getValue().trim();
        ...
        queryString += " MontoDocumento, SerieDocumento, NumeroDocumento, TipoDOCA, NoDOCA, MonedaDocumento,";
        queryString += " IdNomenclatura, Debe, Haber,";
...
//System.out.println("DEBE insert...");
        queryString += ",(";
        queryString += empresaCbx.getValue();
        queryString += ",'INGRESADO'";
        queryString += ",'" + codigoPartida + "'";
        ...
        try {
            ...
            Notification.show("Transacción registrada correctamente.", Notification.Type.HUMANIZED_MESSAGE);
...
//                    numberFormat3.format(montoTxt.getDoubleValueDoNotThrow())
                    numberFormat3.format(debe1Txt.getDoubleValueDoNotThrow())
            );
    ...
    public void desAutorizarFactura() {
        ...
        Iterator iter = prestamosGrid.getSelectedRows().iterator();

        ConfirmDialog.show(UI.getCurrent(), "Confirme:", "Desea eliminar la siguiente autorizacion de este prestamo ?",
                        ...
                        if (dialog.isConfirmed()) {
                            try {
                                ...
                                while (iter.hasNext()) {
                                    ...
                                    String codigoPartida = String.valueOf(prestamosGrid.getContainerDataSource().getItem(gridItem).getItemProperty(NO).getValue());
...
//                                    }
                                ...
                                Notification.show("PAGOS DES-AUTORIZADOS CON EXITO ", Notification.Type.HUMANIZED_MESSAGE);

                                close();

                            } catch (Exception ex) {
                                System.out.println("Error al momento de des autorizar PAGOS : " + ex);
                                ...
                                try {
                                    ...
                                    Logger.getLogger(PagoPrestamoForm.class
                                ...
                                try {
                                    ...
                                    Logger.getLogger(PagoPrestamoForm.class.getName()).log(Level.SEVERE, null, ex2);
                                }
    ...
    public void actualizarPagoPrestamo() {
...
//            ((PagarView) (mainUI.getNavigator().getCurrentView())).documentosContainer.getContainerProperty(((PagarView) (mainUI.getNavigator().getCurrentView())).documentosGrid.getSelectedRow(), PagarView.ESTATUS_PROPERTY).setValue("PAGADO");
            ...
            ex.printStackTrace();
            Logger.getLogger(PagoPrestamoForm.class.getName()).log(Level.SEVERE, null, ex);
