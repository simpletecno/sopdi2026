 ...
 * @author user
 */
public class PagoAnticipoProveedorForm extends Window {
    ...
    static final String IDORDEN_COMPRA_PROPERTY = "IdOrdenCompra";
    ...
    public PagoAnticipoProveedorForm(String tipoAnticipo, Date fechaPago) {
        ...
        titleLbl = new Label("");
        titleLbl.setValue(empresaId + " " + empresaNombre + " " + tipoAnticipo);
        ...
        switch (tipoAnticipo) {
            case AutorizacionesPagoView.ANTICIPO_PROVEEDOR:
                llenarComboProveedor("ESPROVEEDOR = 1");
                break;
//            case AutorizacionesPagoView.ANTICIPO_HONORARIOS:
//                llenarComboProveedor("ESPLANILLA = 1");
//                break;
//            case AutorizacionesPagoView.ANTICIPO_SUELDOS:
//                llenarComboProveedor("ESPLANILLA = 1");
//                break;
            default:
                break;
    ...
    public void createTablaAnticipos() {
        ...
        container.addContainerProperty(CREADOPOR_PROPERTY, String.class, null);
        ...
        container.addContainerProperty(IDORDEN_COMPRA_PROPERTY, String.class, null);

        anticiposGrind = new Grid("Anticipos autorizados", container);
        ...
        anticiposGrind.addSelectionListener(new SelectionListener() {
            ...
            public void select(SelectionEvent event) {
                ...
                if (anticiposGrind.getSelectedRow() != null) {
                    ...
                    String mondeda = String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), MONEDA_PROPERTY).getValue());
                    validadMoneda(mondeda);
                    monedaCbx.setReadOnly(true);

                    idOrdenCompra = String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), IDORDEN_COMPRA_PROPERTY).getValue());

                    generarAnticipo();

                    montoTxt.setReadOnly(false);
                    String monto = String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), MONTO_PROPERTY).getValue()).replaceAll(",", "");
                    ...
                    nombreChequeTxt.setValue(String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), PROVEEDOR_PROPERTY).getValue()));
                    descripcionTxt.setValue(titleLbl.getValue() + " A " + String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), PROVEEDOR_PROPERTY).getValue()));
                }
            }
        });
    ...
    public void llenarTablaAnticipos() {
        ...
        queryString += " AND TipoAutorizacion = '" + tipoAnticipo + "'";
        ...
        try {
            ...
            if (rsRecords.next()) { //  encontrado
                do {
                    ...
                    container.getContainerProperty(itemId, PROVEEDOR_PROPERTY).setValue(rsRecords.getString("Nombre"));
                    ...
                    container.getContainerProperty(itemId, IDORDEN_COMPRA_PROPERTY).setValue(rsRecords.getString("IdOrdenCompra"));
    ...
    private void crearLayoutCheque() {
        ...
        centroCostoCbx.setWidth("12em");
        llenarComboCentroCosto();
        if (tipoAnticipo.equals("ANTICIPO A PROVEEDOR")) {
        ...
        chequeLayout.addComponent(centroCostoCbx);
        chequeLayout.setComponentAlignment(centroCostoCbx, Alignment.MIDDLE_CENTER);
    ...
    public void crearPartidaLayout() {
        ...
        desAutorizarBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                if (anticiposGrind.getSelectedRow() != null) {
                    String idAnticipo = String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), NO_PROPERTY).getValue());
...
//                                    ((PagarView) (mainUI.getNavigator().getCurrentView())).documentosContainer.getContainerProperty(((PagarView) (mainUI.getNavigator().getCurrentView())).documentosGrid.getSelectedRow(), PagarView.ESTATUS_PROPERTY).setValue("NO AUTORIZADO");
    ...
    public void generarAnticipo() {
        ...
        switch (tipoAnticipo) {
            case AutorizacionesPagoView.ANTICIPO_PROVEEDOR:
                cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getAnticiposProveedor());
                break;
//            case AutorizacionesPagoView.ANTICIPO_HONORARIOS:
//                cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getAnticiposHonorarios());
//                break;
//            case AutorizacionesPagoView.ANTICIPO_SUELDOS:
//                cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getAnticiposSueldos());
//                break;
            default:
                break;
        }
    ...
    public void insertarPartidaSimple() {
        ...
        queryString += "," + String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), ID_PROVEEDOR_PROPERTY).getValue());
        queryString += ",''";//nitproveedor
        queryString += ",'" + String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), PROVEEDOR_PROPERTY).getValue()) + "'";
        ...
        try {
            ...
            queryString = "UPDATE orden_compra SET CodigoCCAnticipo = '" + codigoPartida + "'";
...
//            ((PagarView) (mainUI.getNavigator().getCurrentView())).documentosContainer.getContainerProperty(((PagarView) (mainUI.getNavigator().getCurrentView())).documentosGrid.getSelectedRow(), PagarView.ESTATUS_PROPERTY).setValue("PAGADO");
    ...
    public void actualizarAnticiposAutorizados() {
        ...
        try {
            ...
            queryString = "DELETE FROM autorizacion_pago";
            queryString += " WHERE IdAutorizacion = " + String.valueOf(container.getContainerProperty(anticiposGrind.getSelectedRow(), NO_PROPERTY).getValue());
