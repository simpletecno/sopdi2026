...
//                break;
        ...
        anticiposGrind.addSelectionListener(new SelectionListener() {
            ...
            public void select(SelectionEvent event) {
                ...
                if (anticiposGrind.getSelectedRow() != null) {
                    ...
                    descripcionTxt.setValue(titleLbl.getValue() + " A " + container.getContainerProperty(anticiposGrind.getSelectedRow(), PROVEEDOR_PROPERTY).getValue());
                }
            }
        });
    ...
    private void crearLayoutCheque() {
        ...
        centroCostoCbx.setVisible(tipoAnticipo.equals("ANTICIPO A PROVEEDOR"));
...
//                break;
    ...
    public void insertarPartidaSimple() {
        ...
        queryString += "," + container.getContainerProperty(anticiposGrind.getSelectedRow(), ID_PROVEEDOR_PROPERTY).getValue();
        queryString += ",''";//nitproveedor
        queryString += ",'" + container.getContainerProperty(anticiposGrind.getSelectedRow(), PROVEEDOR_PROPERTY).getValue() + "'";
...
//            ((PagarView) (mainUI.getNavigator().getCurrentView())).documentosContainer.getContainerProperty(((PagarView) (mainUI.getNavigator().getCurrentView())).documentosGrid.getSelectedRow(), PagarView.ESTATUS_PROPERTY).setValue("PAGADO");
    ...
    public void actualizarAnticiposAutorizados() {
        ...
        try {
            ...
            queryString = "DELETE FROM autorizacion_pago";
            queryString += " WHERE IdAutorizacion = " + container.getContainerProperty(anticiposGrind.getSelectedRow(), NO_PROPERTY).getValue();
