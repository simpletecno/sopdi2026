 ...
 * @author user
 */
public class IngresoInteresesDevengadosForm extends Window {
    ...
    public IngresoInteresesDevengadosForm(String codigoPartida) {
        ...
        titleLbl = new Label(empresaId + " " + empresaNombre + " INGRESO A BANCOS INTERESES DEVENGADOS");
        ...
        generarPartidaInteresesDevengados();
    ...
    public HorizontalLayout crearComponentes() {
        ...
        tipoIngresoCbx.addItem("INTERESES DEVENGADOS");
        tipoIngresoCbx.select("INTERESES DEVENGADOS");
    ...
    public void generarPartidaInteresesDevengados() {

        monedaCbx.select("QUETZALES");
        cuentaContable1Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getBancosMonedaLocal());
        cuentaContable2Cbx.clear();
        cuentaContable3Cbx.clear();
        cuentaContable2Cbx.select(((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getInteresesDevengados());
    ...
    public void ingresarInteresesDevengados() {
...
//        System.out.println("queryString Ingreso Bancos INTERESES DEVENGADOS = " + queryString);
        Logger.getLogger(this.getClass().getName()).log(Level.INFO, "queryString Ingreso Bancos INTERESES DEVENGADOS = " + queryString);
