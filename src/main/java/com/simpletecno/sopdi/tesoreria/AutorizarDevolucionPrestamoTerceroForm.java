 ...
 * @author user
 */
public class AutorizarDevolucionPrestamoTerceroForm extends Window {
...
//                                    valueTxt.setValue(0.00);
    ...
    public void llenarTablaDevolucionesCliente() {
        ...
        queryString += " AND contabilidad_partida.IdNomenclatura In (" + ((SopdiUI) mainUI).cuentasContablesDefault.getAcreedoresCortoPlazo() + ")";
