...
import static com.simpletecno.sopdi.ventas.FacturaVentaView.DIAHOY_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.FACTURA_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.ESTATUS_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.FECHA_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.MONTO_QUETZALES_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.PROVEEDOR_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.TIPOCAMBIO_PROPERTY;
import static com.simpletecno.sopdi.ventas.FacturaVentaView.VALOR_PROPERTY;
 ...
 * @author JAguirre
 */
public class FacturasVentaPDF extends Window {
    ...
    public FacturasVentaPDF(
        ...
        this.documentosContainer = documentosContainer;
        this.desde = desde;
        this.hasta = hasta;
        ...
        try {
            ...
            fileName = "DocumetosVenta_" + empresaNombre.replaceAll(" ", "_").replaceAll(",", "_").replaceAll("[()]", "").replaceAll("[.]", "") + "_" + new Utileria().getFechaHoraSinFormato() + ".pdf";
    ...
    public class Pdf implements StreamResource.StreamSource, Serializable {
        ...
        public Pdf(String fileName) {
            ...
            try {
                ...
                event.setFirstLineReportTitle("DOCUMENTOS VENTA");
        ...
        private void leerBaseDatosYEscribirLineas(Document document)
            ...
            c1 = new PdfPCell(new Paragraph("T.C.", smallBold10));
            c1.setHorizontalAlignment(Element.ALIGN_CENTER);
            c1.setVerticalAlignment(Element.ALIGN_CENTER);
            c1.setBorderWidth(0);
            c1.setBorderWidthBottom(1);
            ...
            c1 = new PdfPCell(new Paragraph("MONTO Q.", smallBold10));
            c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
            c1.setVerticalAlignment(Element.ALIGN_RIGHT);
            c1.setBorderWidth(0);
            c1.setBorderWidthBottom(1);
...
//                    System.out.println(documentosContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue());
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c1.setVerticalAlignment(Element.ALIGN_CENTER);
                    c1.setBorderWidth(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, DIAHOY_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c1.setVerticalAlignment(Element.ALIGN_CENTER);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, PROVEEDOR_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, FACTURA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, VALOR_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, TIPOCAMBIO_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c1.setVerticalAlignment(Element.ALIGN_CENTER);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, MONTO_QUETZALES_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, ESTATUS_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
