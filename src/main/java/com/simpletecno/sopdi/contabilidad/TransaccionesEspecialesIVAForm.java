    ...
    public void generarTable(String codigoCC) {
        ...
        if (tipoDocumento.equals("TRANSACCION ESPECIAL")) {
            ...
            if (tipoDocumento.equals("CONSTANCIA IVA COMPRA")) {
                ...
                queryString += " and contabilidad_nomenclatura.IdNomenclatura in (" + ((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getClientes() + "," + ((SopdiUI) UI.getCurrent()).cuentasContablesDefault.getAnticiposClientes() + ")";
            }
