...
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.CODIGO_PARTIDA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.CUENTA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.DEBE_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.DESCRIPCION_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.FECHA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroInventarioView.HABER_PROPERTY;
 ...
 * @author JAguirre
 */
public class LibroInventarioPDF extends Window {
    String fileName;
    String queryString;
    ...
    public LibroInventarioPDF(
        ...
        this.libroInventarioContainer = libroInventarioContainer;
        this.desde= desde;
        this.hasta= hasta;
        ...
        try {
            ...
            fileName = "LibroInventario_" + empresaNombre.replaceAll(" ", "_").replaceAll(",", "_").replaceAll("[()]", "").replaceAll("[.]", "") + "_" + desde.replaceAll("/", "")+hasta.replaceAll("/", "") + "_" + new Utileria().getHora() + ".pdf";
            ...
            Notification.show("Error al generar el libro inventario.", Type.ERROR_MESSAGE);
    ...
    public class Pdf implements StreamResource.StreamSource, Serializable {
        ...
        public Pdf(String fileName) {
            ...
            try {
                ...
                event.setFirstLineReportTitle("LIBRO INVENTARIO");
...
//                addFooterPage(document2);
        ...
        private void leerBaseDatosYEscribirLineas(Document document)
            ...
            float[] columnWidths = {1.0f, 1.5f, 1.0f, 2.0f, 1.0f, 1.0f};
            ...
            try {
                ...
                for (Object itemId : libroInventarioContainer.getItemIds()) {

//System.out.println(libroDiarioContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue());

                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, CODIGO_PARTIDA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, CUENTA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, DESCRIPCION_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, DEBE_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroInventarioContainer.getContainerProperty(itemId, HABER_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
