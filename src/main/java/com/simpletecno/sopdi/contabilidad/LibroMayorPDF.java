...
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.CODIGO_PARTIDA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.CUENTA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.DEBE_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.FECHA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.HABER_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroMayorView.SALDO_PROPERTY;
...
public class LibroMayorPDF extends Window {
    ...
    public LibroMayorPDF(
            String idEmpresa, 
            String empresaNombre,
            String empresaNit,
            IndexedContainer libroMayor,
        ...
        this.libroMayorContainer = libroMayor;
        this.desde= desde;
        this.hasta= hasta;
        ...
        try {
            ...
            fileName = "LibroMayor_" + empresaNombre.replaceAll(" ", "_").replaceAll(",", "_").replaceAll("[()]", "").replaceAll("[.]", "")  + "_" + desde.replaceAll("/", "") + hasta.replaceAll("/", "") + "_" + new Utileria().getHora() + ".pdf";
            ...
            Notification.show("Error al generar el libro diario.", Type.ERROR_MESSAGE);
    ...
    public class Pdf implements StreamResource.StreamSource, Serializable {
        ...
        public Pdf(String fileName) {
            ...
            try {
                ...
                document2.setMargins(10, 10, 10, 10);
                ...
                event.setFirstLineReportTitle("LIBRO MAYOR");
                ...
                event.setSecondLineReportTitle("CORRESPONDE A : " + desde + " " + hasta);
...
//                addFooterPage(document2);
        ...
        private void leerBaseDatosYEscribirLineas(Document document)
            ...
            PdfPTable reportTable = new PdfPTable(9);
            PdfPCell c1 = null;

            float[] columnWidths = {1.0f, 1.0f, 2.0f, 1.3f, 3.0f,  1.5f, 1.5f, 1.3f, 1.3f};
            ...
            c1 = new PdfPCell(new Paragraph("DOCTO", smallBold10));
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            c1.setVerticalAlignment(Element.ALIGN_LEFT);
            c1.setBorderWidth(0);
            c1.setBorderWidthBottom(1);
            ...
            c1 = new PdfPCell(new Paragraph("PARTIDA", smallBold10));
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            c1.setVerticalAlignment(Element.ALIGN_LEFT);
            c1.setBorderWidth(0);
            c1.setBorderWidthBottom(1);
            ...
            c1 = new PdfPCell(new Paragraph("SALDO", smallBold10));
            c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
            c1.setVerticalAlignment(Element.ALIGN_RIGHT);
            c1.setBorderWidth(0);
            c1.setBorderWidthBottom(1);
            ...
            try {
                ...
                for (Object itemId : libroMayorContainer.getItemIds()) {

                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, CUENTA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, LibroMayorView.DOCTO_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, LibroMayorView.TIPO_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, LibroMayorView.PROVEEDOR_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, CODIGO_PARTIDA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, DEBE_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, HABER_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroMayorContainer.getContainerProperty(itemId, SALDO_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
