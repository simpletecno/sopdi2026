...
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.CODIGO_PARTIDA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.CUENTA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.DEBE_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.DESCRIPCION_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.FECHA_PROPERTY;
import static com.simpletecno.sopdi.contabilidad.LibroDiarioView.HABER_PROPERTY;
...
public class LibroDiarioPDF extends Window {
    ...
    String empresaNit;
    IndexedContainer libroDiarioContainer;
    String desde;
    String hasta;
    String folioInicial;

    public LibroDiarioPDF(
            String idEmpresa, 
            String empresaNombre, 
            String empresaNit,
        ...
        this.libroDiarioContainer = librodiario;
        this.desde= desde;
        this.hasta= hasta;
        ...
        try {
            ...
            fileName = "LibroDiario_" + empresaNombre.replaceAll(" ", "_").replaceAll(",", "_").replaceAll("[()]", "").replaceAll("[.]", "") + "_" + desde.replaceAll("/", "")+hasta.replaceAll("/", "") + "_" + new Utileria().getHora() + ".pdf";
    ...
    public class Pdf implements StreamResource.StreamSource, Serializable {
        ...
        public Pdf(String fileName) {
            ...
            try {
                ...
                event.setFirstLineReportTitle("LIBRO DIARIO");
...
//                addFooterPage(document2);
        ...
        private void leerBaseDatosYEscribirLineas(Document document)
            ...
            try {
                ...
                for (Object itemId : libroDiarioContainer.getItemIds()) {

//System.out.println(libroDiarioContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue());

                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, CODIGO_PARTIDA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, CUENTA_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, DESCRIPCION_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, DEBE_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(libroDiarioContainer.getContainerProperty(itemId, HABER_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    c1.setVerticalAlignment(Element.ALIGN_RIGHT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
