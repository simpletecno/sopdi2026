...
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.DOCUMENTO_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.ESTATUS_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.FECHA_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.MONTO_QUETZALES_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.NOC_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.PROVEEDOR_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.TIPOCAMBIO_PROPERTY;
import static com.simpletecno.sopdi.compras.IngresoDocumentosView.VALOR_PROPERTY;
 ...
 * @author JAguirre
 */
public class IngresoDocumentosPDF extends Window {
    ...
    public class Pdf implements StreamResource.StreamSource, Serializable {
        ...
        public Pdf(String fileName) {
            ...
            try {
                ...
                event.setFirstLineReportTitle("DOCUMENTOS INGRESADOS");
        ...
        private void leerBaseDatosYEscribirLineas(Document document)
            ...
            c1 = new PdfPCell(new Paragraph("NOC", smallBold10));
...
//                    System.out.println(documentosContainer.getContainerProperty(itemId, FECHA_PROPERTY).getValue());
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, NOC_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
                    c1.setVerticalAlignment(Element.ALIGN_CENTER);
                    c1.setBorderWidth(0);
                    ...
                    c1 = new PdfPCell(new Paragraph(String.valueOf(documentosContainer.getContainerProperty(itemId, DOCUMENTO_PROPERTY).getValue()), small10));
                    c1.setHorizontalAlignment(Element.ALIGN_LEFT);
                    c1.setVerticalAlignment(Element.ALIGN_LEFT);
                    c1.setBorderWidth(0);
                    c1.setBorderWidthBottom(0);
