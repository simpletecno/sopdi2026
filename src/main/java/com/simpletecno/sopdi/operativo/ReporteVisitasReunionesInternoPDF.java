 ...
 * @author JAguirre
 */
public class ReporteVisitasReunionesInternoPDF extends Window {
    ...
    public ReporteVisitasReunionesInternoPDF(
            String idVisita, 
...
//                    c1 = new PdfPCell(new Paragraph(String.valueOf(participantesContainer.getItem(1).getItemProperty("Nombre").getValue()), small10));
        ...
        private void addTasksTable(Document document) {
            ...
            try {
                ...
                float[] columnWidths3 = {1.0f, 3.0f, 1.0f};
                ...
                PdfPTable tareaTable = new PdfPTable(7);

                tareaTable.setSplitRows(false);
                tareaTable.setHeaderRows(0);
                tareaTable.setWidthPercentage(90);

                float[] columnWidths4 = {1.5f, 3.0f, 3.0f, 1.5f, 1.5f, 1.5f, 1.5f};

                tareaTable.setWidths(columnWidths4);

                PdfPCell cell = new PdfPCell(new Paragraph("RESPONSABLE", smallBold10));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setBorderWidth(2);
                ...
                cell = new PdfPCell(new Paragraph("PRESUP.", smallBold10));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setBorderWidth(2);
                tareaTable.addCell(cell);

                cell = new PdfPCell(new Paragraph("GARANTIA", smallBold10));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setBorderWidth(2);
                tareaTable.addCell(cell);

                cell = new PdfPCell(new Paragraph("EQ.DIBUJO", smallBold10));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setBorderWidth(2);
                tareaTable.addCell(cell);

                cell = new PdfPCell(new Paragraph("EJECUTOR", smallBold10));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setBorderWidth(2);
                tareaTable.addCell(cell);
                ...
                while (rsRecords.next()) {
                    ...
                    cell = new PdfPCell(new Paragraph(rsRecords.getString("Responsable"), small10));
                    cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    cell = new PdfPCell(new Paragraph(rsRecords.getString("Presupuesto"), small10));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderWidth(0);
                    tareaTable.addCell(cell);

                    cell = new PdfPCell(new Paragraph(rsRecords.getString("Garantia"), smallBold12));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderWidth(0);
                    tareaTable.addCell(cell);

                    cell = new PdfPCell(new Paragraph(rsRecords.getString("EquipoDibujo"), small10));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderWidth(0);
                    tareaTable.addCell(cell);

                    cell = new PdfPCell(new Paragraph(rsRecords.getString("Ejecutor"), small10));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderWidth(0);
                    tareaTable.addCell(cell);
...
//                addEmptyLine(preface, 1);
                ...
                Logger.getLogger(ReporteVisitasReunionesPDF.Pdf.class.getName()).log(Level.SEVERE, null, ex);
                ex.printStackTrace();
            }
        }
