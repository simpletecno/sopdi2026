...
//                System.out.println("codigoTarea = " + codigoTarea);
                ...
                queryString += ",'" + responsableCbx.getValue() + "'";
                queryString += ",'" + ejecutorCbx.getValue() + "'";
                queryString += ",'" + esTareaCbx.getValue() + "'";
                queryString += ",'" + garantiaCbx.getValue() + "'";
                queryString += ",'" + presupuestoCbx.getValue() + "'";
                queryString += ",'" + autorizadorTipoCbx.getValue() + "'";
                queryString += ",'" + centroCostoCbx.getValue() + "'";
                queryString += ",'" + equipoDibujoCbx.getValue() + "'";
                queryString += ",'" + visibleParaClienteCbx.getValue() + "'";
                ...
                queryString += ",Responsable = '" + responsableCbx.getValue() + "'";
                queryString += ",Ejecutor = '" + ejecutorCbx.getValue() + "'";
                queryString += ",EsTarea = '" + esTareaCbx.getValue() + "'";
                queryString += ",Garantia = '" + garantiaCbx.getValue() + "'";
                queryString += ",Presupuesto = '" + presupuestoCbx.getValue() + "'";
                queryString += ",AutorizadoTipo = '" + autorizadorTipoCbx.getValue() + "'";
                queryString += ",IdCentroCosto = '" + centroCostoCbx.getValue() + "'";
                queryString += ",EquipoDibujo = '" + equipoDibujoCbx.getValue() + "'";
                queryString += ",VisibleParaCliente = '" + visibleParaClienteCbx.getValue() + "'";
