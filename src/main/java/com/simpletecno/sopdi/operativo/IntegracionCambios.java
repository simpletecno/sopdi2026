...
public class IntegracionCambios extends VerticalLayout {
...
*/
        ...
        integracionContainer.addContainerProperty(IDVISITA_PROPERTY,        String.class, null); 
        
        integracionContainer.addContainerProperty(IDTAREA_PROPERTY,         String.class, null); 
        integracionContainer.addContainerProperty(IDEX_PROPERTY,            String.class, null); 
        
        integracionGrid = new Grid("Integración CAMBIOS", integracionContainer);
        ...
        integracionGrid.getColumn(IDVISITA_PROPERTY).setExpandRatio(1).setHidable(true).setHidden(true);
        integracionGrid.getColumn(IDTAREA_PROPERTY).setExpandRatio(1).setHidable(true).setHidden(true);
        ...
        try {
            ...
            if(rsRecords.next()) { //  encontrado
                ...
                do {
                    ...
                    integracionContainer.getContainerProperty(itemId, CODIGO_PROPERTY).setValue(rsRecords.getString("Id"));
                    ...
                    integracionContainer.getContainerProperty(itemId, CANTIDAD_PROPERTY).setValue(rsRecords.getDouble("Cantidad"));
                    integracionContainer.getContainerProperty(itemId, PRECIO_PROPERTY).setValue(rsRecords.getDouble("Precio"));
                    integracionContainer.getContainerProperty(itemId, TOTAL_PROPERTY).setValue(rsRecords.getDouble("Total"));
                    ...
                    integracionContainer.getContainerProperty(itemId, PROVEEDOR_PROPERTY).setValue(rsRecords.getString("ProveedorNombre"));
                    integracionContainer.getContainerProperty(itemId, IDVISITA_PROPERTY).setValue(rsRecords.getString("IdVisita"));
                ...
                documentosFooter.getCell(TOTAL_PROPERTY).setText(moneyFormat.format(totalCuentaQuetzales));
            }
        } 
        catch (Exception ex) {
            Logger.getLogger(IntegracionCambios.class.getName()).log(Level.SEVERE, null, ex);
